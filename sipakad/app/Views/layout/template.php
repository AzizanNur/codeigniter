...
<body class="default-sidebar">
    ...
    <header class="tabMobileView header navbar fixed-top d-lg-none">
        <div class="nav-toggle">
            ...
            <a href="index.html" class=""> <img src="<?php echo base_url('public/assets/img/logo-3.png');?>" class="img-fluid" alt="logo"></a>
        </div>
                ...
                <ul class="navbar-nav theme-brand flex-row  d-none d-lg-flex">
                    <li class="nav-item d-flex">
                        <a href="<?php echo base_url('')?>" class="navbar-brand">
                            <img src="<?php echo base_url('public/assets/img/logo-3.png')?>" class="img-fluid" alt="logo">
                        </a>
                        <p class="border-underline"></p>
                    </li>
                    <li class="nav-item theme-text">
                        <a href="<?php echo base_url('')?>" class="nav-link"> Equation </a>
                    </li>
                </ul>
