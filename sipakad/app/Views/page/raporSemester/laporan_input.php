            ...
            <div class="page-title">
                ...
                <div class="crumbs" style="margin-bottom: -35px;">
                    <ul id="breadcrumbs" class="breadcrumb">
                        ...
                        <li class=""><a href="#">Rapor Semester</a></li>
                        <li class="active"><a href="#">Input Rapor Semester</a></li>
                    </ul>
                </div>
            </div>
        </div>
                        ...
                        <div class="statbox widget box box-shadow">
                            <div class="widget-header">                                
                                <div class="row">
                                    <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                                        <h4>Upload Rapor (Semester) Siswa :</h4>
                                    </div>
                                </div>
                            </div>
                            <div class="widget-content widget-content-area">
                                <form class="form-vertical" action="#">
                                    ...
                                    <div class="form-group mb-4">
                                        <label class="control-label">Tanggal Raport:</label>
                                        <select id="inputState" class="form-control">
                                            <option selected="selected">Januari 2021</option>
                                            <option>Februari 2021</option>
                                        </select>
                                    ...
                                    <div class="form-group mb-4">
                                        <label class="control-label">Satuan Pendidikan:</label>
                                        <select id="inputState" class="form-control">
                                            <option selected="selected">A1</option>
                                            <option>A2</option>
                                        </select>
