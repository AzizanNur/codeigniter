            ...
            <table id="datatable" class="table display  nowrap">
              ...
              <tbody>
			   ...
			   <tr>
                  ...
                  <td><?=$key->USERNAME?></td>
                  <td>
                  <a href="<?=base_url()?>datauser/edit/<?=$key->IDUSER;?>" class="editprod" alt="edit" title="edit"><i class="ion-android-settings"></i> Edit</a>
                  <a href="javascript:void(0)" class="hapuskat" alt="edit" title="hapus" id="<?=base_url()?>datauser/delete/<?=$key->IDUSER;?>"><i class="ion-android-delete"></i> Hapus</a>
                  </td>
