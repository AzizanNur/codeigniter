            ...
            <table id="datatable" class="table display  nowrap">
              ...
              <tbody>
			   ...
			   <tr>
                  ...
                  <td><?=$key->KATMARKET?></td>
                  <td>
                  <a href="<?=base_url()?>market_kat/edit/<?=$key->IDMARKETKAT;?>" class="editprod" alt="edit" title="edit"><i class="ion-android-settings"></i> Edit</a>
                  <a href="javascript:void(0)" class="hapuskat" alt="edit" title="hapus" id="<?=base_url()?>market_kat/delete/<?=$key->IDMARKETKAT;?>"><i class="ion-android-delete"></i> Hapus</a>
                  </td>
