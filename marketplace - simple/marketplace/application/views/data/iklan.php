	...
	<div class="br-section-wrapper">
            ...
            <table id="datatable" class="table display  nowrap">
              ...
              <tbody>
			   ...
			   <tr>
                  <td><?=$i?></td>
                  <td> <img class="d-flex mg-r-40 wd-150" src="<?=base_url()?>assets/iklan/<?=$key->GAMBAR;?>" alt="Image"></td>
                  <td><?=$pos?></td>
                  <td>
                  <a href="<?=base_url()?>iklan/edit/<?=$key->IDIKLAN;?>" class="editprod" alt="edit" title="edit"><i class="ion-android-settings"></i> Edit</a>
                  <a href="javascript:void(0)" class="hapuskat" alt="edit" title="hapus" id="<?=base_url()?>iklan/delete/<?=$key->IDIKLAN;?>"><i class="ion-android-delete"></i> Hapus</a>
                  </td>
