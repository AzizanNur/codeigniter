            ...
            <div class="col-xl-6">
              ...
              <div class="form-layout form-layout-4">
                ...
                <div class="row mg-t-20">
                  ...
                  <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                    <input type="text" class="form-control" placeholder="" name="admin" value="<?php echo (isset($row->ADMIN)) ? $row->ADMIN : ''; ?>" required>
                  </div>
                </div>
                <div class="row mg-t-20">
                  ...
                  <div class="col-sm-8 mg-t-10 mg-sm-t-0">
            		...
            		?>
            		 <option <?=$select?> value="<?=$key->IDMARKETKAT?>"><?=$key->KATMARKET?></option>
            		<?}?>
            		</select>
                  </div>
                </div>
